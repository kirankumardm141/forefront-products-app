package com.forefront.rest.webservices.restfulwebservices.jwt;
...
public class JWTWebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		httpSecurity.csrf().disable().exceptionHandling()
				...
				.sessionCreationPolicy(SessionCreationPolicy.STATELESS).and().authorizeRequests().mvcMatchers(HttpMethod.GET, "/jpa/users/kiran/products").permitAll().anyRequest()
				.authenticated();
